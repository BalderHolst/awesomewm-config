...
beautiful.init("/home/balder/.config/awesome/themes/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "w", function() awful.util.spawn("connect") end,
        { description = "connect to a wifi", group = "launcher" }),
    awful.key({ modkey }, "e", function() awful.util.spawn("open_dir") end,
        { description = "open a bookmarked dir in shell", group = "launcher" }),
    awful.key({ modkey, "Shift" }, "e", function() awful.util.spawn("powerdown") end,
